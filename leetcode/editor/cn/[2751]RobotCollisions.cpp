...
//directions (directions[i] is either 'L' for left or 'R' for right). All integers in 
...
//continues in the same direction it was going. If both robots have the same health, they 
//are both removed from the line. 
//
// Your task is to determine the health of the robots that survive the 
//collisions, in the same order that the robots were given, i.e. final health of robot 1 (
//if survived), final health of robot 2 (if survived), and so on. If there are no 
...
//robot 2 will collide, and since both have the same health, they will be removed 
//from the line. Next, robot 3 and robot 4 will collide and since robot 4's health is 
...
//health, they are both removed. Robot 3 and 4 will collide and since both have the 
//same health, they are both removed. So, we return an empty array, []. 
//
// 
// Constraints: 
//
...
// 
//
// Related Topics 栈 数组 排序 模拟 👍 22 👎 0
