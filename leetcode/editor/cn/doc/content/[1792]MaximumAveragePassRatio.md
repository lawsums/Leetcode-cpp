...
<pre>
<strong>Input:</strong> classes = [[1,2],[3,5],[2,2]], <span><code>extraStudents</code></span> = 2
...
<pre>
<strong>Input:</strong> classes = [[2,4],[3,9],[4,5],[2,10]], <span><code>extraStudents</code></span> = 4
...
<div><div>Related Topics</div><div><li>贪心</li><li>数组</li><li>堆（优先队列）</li></div></div><br><div><li>👍 172</li><li>👎 0</li></div>